        ...
        <div class="col-sm-12">
            <div class="card card-dark">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                {{Form::select("client_id", $formJobLog['client_id'], $model["client_id"], ["class" => "form-control select2", "id" => "client_id"])}}
                            </div>
                        </div>
                        {{--Project--}}
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                {{Form::select("project_id", ['' => __("form.base.attr.select_empty_val")] + $formJobLog['project_id'], $model["project_id"] ?? null, ["class" => "form-control select2", "id" => "project_id"])}}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                {{Form::select("services_item_id", ['' => __("form.base.attr.select_empty_val")] + $formJobLog['service_item_id'], $model["services_item_id"], ["class" => "form-control select2", "id" => "services_item_id"])}}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {{Form::select("user_exec[]", $formJobLog['user_exec'], $model["user_exec"],
                                    [
                                        "class" => "duallistbox",
                                        'expanded' => true,
                                        "multiple" => "multiple",
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                {{Form::number("count", $model['count'], ["class" => "form-control", "id" => "count"])}}
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                {{Form::label(__("form.job_log.create.attr.coefficient"))}}
                                {{Form::select("coefficient", $formJobLog['coefficient'], $model['coefficient'], ["class" => "form-control select2", "id" => "coefficient"])}}
                            </div>
                        </div>
                        <div class="col-4">
                            {{--Unit--}}
                        ...
                        <div class="col-sm-12">
                            <div class="card card-info collapsed-card">
                                ...
                                <div class="card-body">
                                    ...
                                    {{Form::textarea("comment", $model['comment'], ["class" => "form-control"])}}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            {{Form::submit(__("basic.label.save"), ["class" => "form-control btn btn-success", "id" => "btn_add"])}}
                        </div>
                    </div>
                    {{Form::close()}}
                </div>
